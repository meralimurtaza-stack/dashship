/**
 * ProjectContext.tsx (v2 — simplified with anonymous auth)
 *
...
export function ProjectProvider({ children }: { children: ReactNode }) {
  ...
  //
  // Requires user to exist (anonymous or real). The Home page
  // should call signInAnonymously() before createProject() if
  // user is null — this is handled in the Home page component,
  // not here. Separation of concerns: AuthContext manages auth,
  // ProjectContext manages projects.
